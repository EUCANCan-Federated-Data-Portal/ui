...
module.exports = withPlugins([withTM], {
  publicRuntimeConfig: {
    ...
    NEXT_PUBLIC_ARRANGER_FILES_PROJECT_ID: process.env.NEXT_PUBLIC_ARRANGER_FILES_PROJECT_ID,
    NEXT_PUBLIC_ARRANGER_FILES_GRAPHQL_FIELD: process.env.NEXT_PUBLIC_ARRANGER_FILES_GRAPHQL_FIELD,
    NEXT_PUBLIC_ARRANGER_FILES_INDEX: process.env.NEXT_PUBLIC_ARRANGER_FILES_INDEX,
    NEXT_PUBLIC_ARRANGER_VARIANTS_PROJECT_ID: process.env.NEXT_PUBLIC_ARRANGER_VARIANTS_PROJECT_ID,
    NEXT_PUBLIC_ARRANGER_VARIANTS_GRAPHQL_FIELD: process.env.NEXT_PUBLIC_ARRANGER_VARIANTS_GRAPHQL_FIELD,
    NEXT_PUBLIC_ARRANGER_VARIANTS_INDEX: process.env.NEXT_PUBLIC_ARRANGER_VARIANTS_INDEX,
